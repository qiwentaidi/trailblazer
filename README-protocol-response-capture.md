...
- [pkg/core/crawl/protocol_hooks.go](pkg/core/crawl/protocol_hooks.go)
...
- [pkg/core/crawl/handless.go](pkg/core/crawl/handless.go)
...
- [pkg/core/database/models.go](pkg/core/database/models.go)
...
- 网络采集入口：[pkg/core/crawl/handless.go](pkg/core/crawl/handless.go)
- 协议钩子脚本：[pkg/core/crawl/protocol_hooks.go](pkg/core/crawl/protocol_hooks.go)
- 出库归一化：[pkg/core/database/models.go](pkg/core/database/models.go)
- 协议轨迹查询：[pkg/core/database/query.go](pkg/core/database/query.go)
- SDK 输出结构：[pkg/lib/sdk.go](pkg/lib/sdk.go)
...
- 解密核心：[pkg/core/protocoltool/tool.go](pkg/core/protocoltool/tool.go)
- Web 接口：[pkg/web/protocol_tools.go](pkg/web/protocol_tools.go)
...
- [pkg/core/protocoltool/tool.go](pkg/core/protocoltool/tool.go)
