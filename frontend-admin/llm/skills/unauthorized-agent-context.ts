...
export const unauthorizedDetectionCapabilities: CapabilityPoint[] = [
  {
    ...
    evidence: [
      'backend/pkg/core/scanexec/target.go',
      'backend/pkg/web/unauth_noise.go',
  ...
  },
  {
    ...
    evidence: [
      'backend/pkg/lib/sdk.go',
      'backend/pkg/config/options.go',
      'backend/config.yaml',
    ],
  },
  {
  ...
  },
  {
    ...
    evidence: ['backend/pkg/core/database/sqlite.go'],
  },
];
