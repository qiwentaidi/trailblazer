...
func resolveAssets() (fs.FS, []byte, string, error) {
	if subFS, index, err := loadEmbeddedAssets(); err == nil {
		return subFS, index, "embedded webassets/dist", nil
	}
	...
	return nil, nil, "", fmt.Errorf(
		"frontend assets not found: build frontend and copy it into webassets/dist, or keep frontend-admin/dist available locally",
	)
}
